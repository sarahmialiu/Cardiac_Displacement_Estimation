...
def vis_GUI(us_scan, optical_viren_folder, vxm_viren_folder, opt_flow, hzn_flow, vert_flow, dep_flow, lowest_res):
    ...
    us = resize_4d(us_scan[:30], normalize=True)
    ...
    optvect = optvectorax.quiver(optX, optY, hzn_opt_flow[time_index, :, :, slice_index], vert_opt_flow[time_index, :, :, slice_index], color='red', scale=60)
    optvectorax.set_title(f"Optical Displacement")
    optvectorax.set_axis_off()
    ...
    def update_display():
        ...
        optvectorimg.set_data(us_data)
        optvect.set_UVC(optvect_data1, optvect_data2)
        vxmvectorimg.set_data(us_data)
...
# optical_viren_path = "/home/sarahl/Documents/Fall Rotation/voxelmorph/out/Compare_Optical_Vxm_2025-07-07/Viren2d_Flows_refFrame_Optical"
# vxm_viren_path = "/home/sarahl/Documents/Fall Rotation/voxelmorph/out/Compare_Optical_Vxm_2025-07-07/Viren2d_Flows_refFrame_Predicted"
# hzn_flow = np.load("/home/sarahl/Documents/Fall Rotation/voxelmorph/out/Compare_Optical_Vxm_2025-07-07/Viren2d_Flows_refFrame_Predicted/hzn_flow_jump.npy")
# vert_flow = np.load("/home/sarahl/Documents/Fall Rotation/voxelmorph/out/Compare_Optical_Vxm_2025-07-07/Viren2d_Flows_refFrame_Predicted/vert_flow_jump.npy")
# dep_flow = np.load("/home/sarahl/Documents/Fall Rotation/voxelmorph/out/Compare_Optical_Vxm_2025-07-07/Viren2d_Flows_refFrame_Predicted/dep_flow_jump.npy")
...
us = np.load("/home/sarahl/Documents/Fall Rotation/voxelmorph/Optical Flow from Jan Lebert/2025-07-07_US04/2025-07-07_US04.npy")
optical_viren_path = "/home/sarahl/Documents/Fall Rotation/voxelmorph/out/Compare_Optical_Vxm_2022-12-25/Viren2d_Flows_refFrame_Jan"
vxm_viren_path = "/home/sarahl/Documents/Fall Rotation/voxelmorph/out/Compare_Optical_Vxm_2022-12-25/Viren2d_Flows_refFrame_Predicted"
hzn_flow = np.load("/home/sarahl/Documents/Fall Rotation/voxelmorph/out/Compare_Optical_Vxm_2022-12-25/hzn_flow_refFrame.npy") 
vert_flow = np.load("/home/sarahl/Documents/Fall Rotation/voxelmorph/out/Compare_Optical_Vxm_2022-12-25/vert_flow_refFrame.npy")
dep_flow = np.load("/home/sarahl/Documents/Fall Rotation/voxelmorph/out/Compare_Optical_Vxm_2022-12-25/dep_flow_refFrame.npy")
