...
import os
import matplotlib
<<<<<<< HEAD:optical_flow_vis.py
from PIL import Image
matplotlib.use("TkAgg")   # Or "Qt5Agg"
=======
# matplotlib.use("TkAgg")   # Or "Qt5Agg"
>>>>>>> 9b15f4862ef3b40d2f2baa83249acb52e35cdc8c:optical_flow_generate_vis.py
...
def vis_GUI(viren_folder, res):
    ...
    slice_index = res // 2
    total_frames = len(glob.glob(hzn_dep_folder + "/*")) // res
...
# Load volume
<<<<<<< HEAD:optical_flow_vis.py
viren2d_savepath = "out/Optical_Unmasked/Viren2d_Flows_refFrame_Jan"
